...
user_one = 'content'
user_two = '//*[id = "content"]/div/div[1]/img'
...
def hover_over_element_one_and_click(driver_instance):
    hover_over_element(driver_instance,
                       driver_instance.find_elemnt_by_xpath(user_one))
    elem = driver_instance.find_elemnt_by_xpath(link_one)

def hover_over_element_two_and_click(driver_instance):
    hover_over_element(driver_instance,
                       driver_instance.find_elemnt_by_xpath(user_two))
    elem = driver_instance.find_elemnt_by_xpath(link_two)


def hover_over_element_three_and_click(driver_instance):
    hover_over_element(driver_instance,
                       driver_instance.find_elemnt_by_xpath(user_three))
    elem = driver_instance.find_elemnt_by_xpath(link_three)
