...
from page_objects import auth_confirm_page, basic_auth_page, \
    file_upload_page, hovers_page, main_page, not_found_page, \
    upload_confirmation_page
...
class Tests(unittest.TestCase):
    def setUp(self):
        ...
        def test_basic_auth_send_correct_keys(self):
            ...
            self.assertTrue(
                auth_confirm_page.message_content_visible(self.driver))
        ...
        def test_hovers_user_one(self):
            ...
            self.assertTrue(not_found_page.not_found_message_visible(
                self.driver))
        ...
        def test_upload_file(self):
            ...
            self.assertTrue(file_upload_page.file_upload_content_visible(
                self.driver))
